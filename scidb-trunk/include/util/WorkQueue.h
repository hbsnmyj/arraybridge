...
public: // subclasses
                      ...
                      INVALID_QUERY_ID)
    {
        ...
        {
            Exception::Pointer ep(std::make_shared<OverflowException>(_file.c_str(),
                    _function.c_str(),
                    _line));
            return ep;
        }
...
public: // methods
     ...
     */
    WorkQueue(const std::shared_ptr<JobQueue>& jobQueue);
...
private:
    ...
    public:
        ...
        : Job(std::shared_ptr<Query>()), _workQueue(workQ)
        {
            /*
