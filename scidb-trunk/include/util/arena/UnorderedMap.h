...
class unordered_map : public SCIDB_MANAGED_BASE(std,unordered_map,K,V,H,P)
{
 private:            // Implementation
                        SCIDB_MANAGED_UNORDERED(std,unordered_map,K,V,H,P)
 ...
 */
template<class K,class V,class H = std::hash<K>,class P = std::equal_to<K> >
class unordered_multimap : public SCIDB_MANAGED_BASE(std,unordered_multimap,K,V,H,P)
{
 private:            // Implementation
                        SCIDB_MANAGED_UNORDERED(std,unordered_multimap,K,V,H,P)
